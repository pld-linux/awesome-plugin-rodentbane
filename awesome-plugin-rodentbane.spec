...
Rodenbane jest implementacją idei "keynav" w module jeżyka lua dla
...
znacząco usprawnić pracę z komputerem. Rodenbane pozwala obejść się
...
stronach www. Rodenbane nie zastępuje jednak w pełni myszy. Czasem
